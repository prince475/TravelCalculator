...
function Benefits({selectedPlan, setSelectedPlan}) {
  ...
  const maxSumInsuredValues = {
    ...
    Premium: {
      ...
      'War & Terrorism': 'Optional - Covered at an additional premium of 25% of the Basic premium',
    },
    Schnegen: {
        ...
        <div className='overflow-auto rounded-lg shadow'>
          <table className='w-full'>
            ...
            <tbody className='divide divide-gray-300'>
              {Object.entries(maxSumInsuredValues[selectedPlan]).map(([section, maxSumInsured]) => (
                <tr key={section}>
                  <td className='p-3 text-sm text-gray-700 whitespace-nowrap'>
                    <span className='trow'>{section}</span>
                  </td>
                  <td className='p-3 text-sm text-gray-700 whitespace-nowrap'>{maxSumInsured}</td>
